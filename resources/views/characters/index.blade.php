...
@section('title', 'Profil Karakter — GTAVerse')
...
<section class="mx-auto max-w-7xl px-6 pb-24 pt-36">
    <div class="reveal max-w-2xl">
        ...
        <h1 class="mt-3 font-display text-5xl uppercase sm:text-6xl">Profil <span class="text-gta-accent">Karakter</span></h1>
        <p class="mt-4 text-zinc-400">Tokoh utama dari setiap entri Grand Theft Auto — kisah, peran, dan pengisi suaranya.</p>
    </div>
    ...
    <div class="mt-10 grid grid-cols-2 gap-5 sm:grid-cols-3 lg:grid-cols-4">
        ...
        @empty
            <p class="col-span-full py-16 text-center text-zinc-500">Belum ada karakter pada filter ini.</p>
        @endforelse
    </div>
</section>
@endsection
