...
@section('content')
    <div class="mb-8 flex flex-wrap items-end justify-between gap-3">
        ...
        <a href="{{ route('characters.show', $character) }}" target="_blank" class="text-xs font-bold uppercase tracking-widest text-cyan-400 hover:underline">Lihat halaman publik ↗</a>
    </div>
